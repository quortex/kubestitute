...
// WithID adds the id to the get instance params
func (o *GetInstanceParams) WithID(id string) *GetInstanceParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get instance params
func (o *GetInstanceParams) SetID(id string) {
	o.ID = id
}
