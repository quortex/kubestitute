...
// WithID adds the id to the terminate instance params
func (o *TerminateInstanceParams) WithID(id string) *TerminateInstanceParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the terminate instance params
func (o *TerminateInstanceParams) SetID(id string) {
	o.ID = id
}
