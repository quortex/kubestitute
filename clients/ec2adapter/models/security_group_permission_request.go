...
// SecurityGroupPermissionRequest security group permission request
//
// swagger:model SecurityGroupPermissionRequest
type SecurityGroupPermissionRequest struct {
...
// Validate validates this security group permission request
func (m *SecurityGroupPermissionRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SecurityGroupPermissionRequest) validateIPRanges(formats strfmt.Registry) error {
...
func (m *SecurityGroupPermissionRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SecurityGroupPermissionRequest) UnmarshalBinary(b []byte) error {
	var res SecurityGroupPermissionRequest
