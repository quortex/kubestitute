...
Content retrieved from cluster-autoscaler version 1.30.2:
https://github.com/kubernetes/autoscaler/blob/cluster-autoscaler-1.30.2/cluster-autoscaler/clusterstate/api/types.go
*/
